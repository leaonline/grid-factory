...
describe(getCheckExtension.name, () => {
  it('returns an empty function if validateUser is not given', (done) => {
  ...
  it('checks the extension against the given set', () => {
    ...
    expect(checkExtensions({ extension: 'baz' })).to.equal(
      'filesCollection.invalidExtension',
    )
  })
  it('returns an i18n compatible string with options', (done) => {
